      ...
      <form onSubmit={handleSubmit(handleCreateNewCycle)}>
        <CyclesContext.Provider
          value={{
            ...
            amountSecondsPassed,
            setSecondsPassed,
          }} // enviando os valores e funções para os componentes filhos desse contexto
        >
          <FormProvider {...newCycleForm}>
            {' '}
            {/* Pegando todos as propriedades do newCycleform por meio do spread */}
            <NewCycleForm />
          </FormProvider>
          <Countdown />
        </CyclesContext.Provider>
